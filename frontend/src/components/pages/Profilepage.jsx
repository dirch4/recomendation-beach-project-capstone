            ...
            {!editMode ? (
              <>
                ...
                <button
                  ...
                  className="w-full border border-blue-600 text-blue-600 px-4 py-2 rounded hover:bg-sky-950 hover:text-sky-200 transition"
                >
                  ✏️ EDIT PROFILE
                </button>
              </>
              ...
              <>
                ...
                <div className="w-full">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="mt-2 w-full bg-sky-800 text-white px-4 py-2 rounded hover:bg-sky-700 flex justify-center items-center gap-2"
                  >
                ...
                <button
                  ...
                  className="w-full mt-4 border border-gray-400 text-gray-700 px-4 py-2 rounded hover:bg-gray-100"
                >
                  Cancel
                </button>
              </>
