          ...
          <div className="flex justify-center mt-8 sm:mt-10">
            <div className="relative w-full max-w-md px-2">
				<input
				  ...
				  className="w-full px-2 py-3 pr-20 text-black rounded-full border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500"
				/>
              <button
